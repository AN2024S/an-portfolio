...
const ProjectsSection = ({ darkMode, projectData, onSelectProject }) => {
  return (
    <section id="projects" className="py-3.5 px-6 max-w-7xl mx-auto">
      <div className="flex items-center gap-4 mb-7">
        <h2 className="text-3xl md:text-6xl font-black tracking-tighter">أبرز <span className="text-accent">أعمالي</span></h2>
        <div className="h-[2px] flex-1 bg-gradient-to-l from-accent/40 to-transparent"></div>
      </div>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-7">
        {projectData.map((project, i) => (
          <motion.div 
            ...
            className={`p-6 rounded-[2rem] border ${darkMode ? 'bg-white/[0.03] border-accent/90' : 'bg-white border-slate-300 shadow-xl'} relative group text-center flex flex-col items-center`}
          >
